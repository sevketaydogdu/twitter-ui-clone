                ...
                <View>
                  ...
                  dark:bg-slate-800">
                    ...
                    <TextInput
                      ...
                      className={`${isFocused && inputValue ? 'flex-1 ' : ''} dark:placeholder place-content-start rounded-full px-4   py-3 placeholder:font-normal  placeholder:color-slate-500 dark:color-white `}
  ...
  if (isFocused)
    return (
      <Animated.View
        ...
        <Container className="h-full w-full items-center  ">
